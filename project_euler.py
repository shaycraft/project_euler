...
def problem11():
    ...
    for i in range(0, size):
        for j in range(3, size):
            if j + 3 < size:
                sums.append(sum_horizontal(m, i, j))
            if i + 3 < size:
                sums.append(sum_vertical(m, i, j))
            if i + 3 < size and j + 3 < size:
                sums.append(sum_diagonal_nwse(m, i, j))
            if i >= 3 and j + 3 < size:
                sums.append(sum_diagonal_swne(m, i, j))
